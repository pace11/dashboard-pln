...
export default function PostsDetail({ isMobile }) {
  ...
  const showConfirmChangeStatus = ({ type }) => {
    Modal.confirm({
      ...
      cancelText: 'No',
      onOk: async () => {
        console.log('form => ', formStatus.getFieldValue('posted'))
            ...
            <RoleComponentRender
              condition={
                (!!detailPost?.data?.is_checker ||
                  !!detailPost?.data?.is_admin) &&
                detailPost?.data?.status === 'pending'
              }
            >
              <Button
                ...
                onClick={() => {
                  ...
                  formStatus.setFieldsValue({ status: 'checked' })
                }}
              >
                Checked Post
              </Button>
            ...
            <RoleComponentRender
              condition={
                (!!detailPost?.data?.is_approver ||
                  !!detailPost?.data?.is_admin) &&
                detailPost?.data?.status === 'checked'
              }
            >
              <Button
                ...
                onClick={() => {
                  ...
                  formStatus.setFieldsValue({ status: 'approved' })
                }}
              >
                Approved Post
              </Button>
            ...
            >
              <Button
                ...
                onClick={() => {
                  ...
                  formStatus.setFieldsValue({ status: 'rejected' })
                }}
              >
                Rejected Post
              </Button>
                    ...
                    columns={[
                      ...
                      },
                      {
                        ...
                        render: (item) => (
                          <Space direction="vertical">
                            <Typography.Text>
                              {item?.approved_by_date
                                ? dayjs(item?.approved_by_date)
                                    .locale('id')
                                    .format('DD MMMM YYYY')
                                : ''}
                            </Typography.Text>
                      ...
                      },
                      {
                        ...
                        render: (item) => (
                          <Space direction="vertical">
                            <Typography.Text>
                              {item?.rejected_by_date
                                ? dayjs(item?.rejected_by_date)
                                    .locale('id')
                                    .format('DD MMMM YYYY')
                                : ''}
                            </Typography.Text>
